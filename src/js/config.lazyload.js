...
angular.module('app')
   ...
   */
  .constant('JQ_CONFIG', {
    easyPieChart: ['../bower_components/bower-jquery-easyPieChart/dist/jquery.easypiechart.fill.js'],
    ...
    sortable: ['../bower_components/html.sortable/dist/html.sortable.angular.js',
