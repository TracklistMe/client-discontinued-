 ...
 */
app.controller('AdmincurrenciesCtrl', function($scope, $http, CONFIG, $filter, editableOptions, editableThemes) {
    ...
    $scope.findConvertedPrice = function(masterPrice, currency) {
        ...
        for (var i = 0; i < $scope.priceTable.length; i++) {
            if ($scope.priceTable[i].MasterPrice == masterPrice && $scope.priceTable[i].CurrencyId == currency) {
