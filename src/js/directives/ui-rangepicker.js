 ...
 angular.module('app').directive('input', ['$compile', '$parse', '$filter', function($compile, $parse, $filter) {
   return {
     restrict: 'E',
     require: '?ngModel',
     link: function($scope, $element, $attributes, ngModel) {
       ...
       $scope.$watch(function() {
         ...
         var jqueryObject = $element.data('daterangepicker').container;
         ...
         $element.data('daterangepicker').container.addClass('show-calendar')
         $element.data('daterangepicker').cb = function(start, end, label) {
           // workaround to keep the calendar always open
           jqueryObject.addClass('show-calendar');
           ($attributes.callback && $parse($attributes.callback)($scope))(start, end, label);
         }
       });
